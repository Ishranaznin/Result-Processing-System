...
$sql="update  tblsubjects set SubjectName=:subjectname,SubjectCode=:subjectcode,Group_Sub=:science_business_group where id=:sid";
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" name="Update" class="btn btn-primary">Update</button>
                                                             <a href="manage-subjects.php" class="btn btn-default">Back</a>
                                                        </div>
                                                    </div>
                                                </form>
