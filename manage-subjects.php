...
$status=1;
$sql="delete from tblclasses where id=:scid ";
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            ...
                                                            <td><?php echo htmlentities($result->Group_Sub);?></td>
...
<a href="manage-subjects.php?scid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete this record?');"><i class="fa fa-trash" title="Delete Record"></i></a>
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
