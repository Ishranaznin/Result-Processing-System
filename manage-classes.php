...
$status=1;
$sql="delete from tblclasses where id=:acid ";
        ...
        <div class="panel-body p-20">
            ...
            <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <td>
                    ...
                    <a href="manage-classes.php?acid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete this record?');"><i class="fa fa-trash" title="Delete Record"></i></a>
                </td>
